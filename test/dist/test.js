...
tape( 'the function returns the first UTF-16 code unit of a provided string', function test( t ) {
	var out;
...
tape( 'the function supports returning the first `n` UTF-16 code units of a provided string', function test( t ) {
	var out;
